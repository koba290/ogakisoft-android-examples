 ...
 */
public class EditDigitPreference extends DialogPreference {
    /**
    ...
    private InputFilter[] filters = { new DigitInputFilter() };
    
    public EditDigitPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    public EditDigitPreference(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextPreferenceStyle);
    }

    public EditDigitPreference(Context context) {
        this(context, null);
    }
